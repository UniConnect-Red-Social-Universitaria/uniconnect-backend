...
app.get('/', (req, res) => {
    res.status(200).json({
        ...
        endpoints: {
            ...
            cerrarGrupo: 'PATCH /api/grupos/:grupoId/cerrar',
            cambiarAdministradorGrupo: 'POST /api/grupos/:grupoId/administrador',
            salirGrupo: 'POST /api/grupos/:grupoId/salir',
            unirseGrupo: 'POST /api/grupos/:grupoId/unirse',
            agregarMiembroGrupo: 'POST /api/grupos/:grupoId/miembros',
            removerMiembroGrupo: 'DELETE /api/grupos/:grupoId/miembros/:usuarioId',
            subirPdfGrupo: 'POST /api/grupos/:grupoId/archivos (form-data archivo)',
            listarPdfGrupo: 'GET /api/grupos/:grupoId/archivos',
            descargarPdfGrupo: 'GET /api/grupos/:grupoId/archivos/:archivoId/descargar',
